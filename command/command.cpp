...
const Parameters &Command::getParameters() const
{
    return parameters;
}

void Command::setCommand(const QString &name)
{
    this->command=name;
}

void Command::addParameter(const QVariant &value)
{
    this->parameters.append(value);
}
