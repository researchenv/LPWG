...
typedef QVariantList Parameters;
...
public:
    ...
    virtual const CommandLineInput &getCommandLine() const = 0;

    virtual void execCommand(GraphicsWidget *gw, const Parameters &parameters) = 0;
};
